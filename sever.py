...
def run(ck, ca):
    ...
    while True:
        ...
        for friend in friendlist:
            users[friend].send((userName.decode("utf-8") + ":" + infolist[1]).encode("utf"))
        # 要发送信息的客户端向目标客户端发送信息
